    ...
    <div className="CategoryCopon my-5">
      ...
      <div className="relative flex items-center group ">
        <FaArrowAltCircleLeft
          size={55}
          className="absolute left-0 z-[110] text-white opacity-50 hover:opacity-100  ease-in-out duration-300 invisible	 group-hover:visible cursor-pointer"
          onClick={moveLeft}
        />
        <div
          id={`slider` + cateTitle}
          className="hidddddd w-full h-full  overflow-x-scroll whitespace-nowrap scroll-smooth scrollbar-hide relative pr-3"
        >
          {moveList &&
            moveList.map(
              (item) =>
        ...
        <FaArrowAltCircleRight
          size={55}
          className="absolute right-0 z-[110] text-white opacity-50 hover:opacity-100  ease-in-out duration-300 invisible	 group-hover:visible cursor-pointer"
          onClick={moveRight}
        />
      </div>
    </div>
