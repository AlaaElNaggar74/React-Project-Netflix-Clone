  ...
  return (
    <div className="creaaaatt  ">
      {/* <img
        ...
        alt="errror"
      /> */}
      {/* <div className="fixed bg-black/60 w-full  h-screen  top-0 left-0 z-[-100]"></div> */}
      <div className=" w-full h-full px-4  py-24 z-[50]">
        <div className=" max-w-[400px]  pt-8 pb-16 px-8 rounded mx-auto bg-black/80 text-white">
          ...
          <div className="text-gray-500">
            ...
            {/* <div>
              <h1>gghhgggggggggggggggggggggggg</h1>
              <h1>gghhgggggggggggggggggggggggg</h1>
              <h1>gghhgggggggggggggggggggggggg</h1>
              <h1>gghhgggggggggggggggggggggggg</h1>
              <h1>gghhgggggggggggggggggggggggg</h1>
